...
var taskInput=document.querySelector(".add-item-block__text-input");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    label.className='tasks-list__task-text';

    //Each elements, needs appending
    listItem.className = "tasks-list__item";
    checkBox.type="checkbox";
    checkBox.className = "tasks-list__checkbox-input";
    editInput.type="text";
    editInput.className="tasks-list__text-input text-input";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="tasks-list__edit-button text-button";

    deleteButton.className="tasks-list__delete-button";
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.className = "tasks-list__delete-button-icon";
...
var addTask=function(){
    ...
    //Create a new list item with the text from the .add-item-block__input:
